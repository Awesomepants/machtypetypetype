...
const targetWPM = 9;
      ...
      function create() {
        ...
        const finishedEmitter = new Phaser.Events.EventEmitter();
        const modal = (modalText, miliseconds, andThen) => {
          ...
          this.tweens.addCounter({
            ...
            onUpdate: (tween) => {
              ...
              mBackgrounds.fillRect(((config.width/2) - (modalTextObject.width/2) - 30), ((config.height/2)-(30 * t)), (modalTextObject.width + 60), 60*t);
            }
          })
        ...
        const infiniteMode = (initialWPM) => {
          ...
          finishedEmitter.on("Mistake", ()=>{
            console.log("finishedEmitter activated")
            this.currentTextObject.x -= 30;
          })
          finishedEmitter.on("Finished", (WPM, accuracy) => {
            modal("WPM: " + Math.floor(WPM) + " Accuracy: " + Math.floor(accuracy*100) + "%", 3000, again);
          });
        };
      ...
      function update(time, delta) {
        ...
        if (this.currentTextObject) {
          ...
          if (this.currentTextObject.x < -100) {
            alert("wow you lost sucker");
